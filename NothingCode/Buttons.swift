...
struct Buttons: View {
    ...
    var body: some View {
        ...
        .animation(.spring(response: 0.5, dampingFraction: 0.5, blendDuration: 0)) // 给容器里面的全部加上动画
...
struct RectangleButton: View {
    ...
    var body: some View {
        Text("Buttons")
            ...
            .background(
                ZStack {
                    ...
                    RoundedRectangle(cornerRadius: 16, style: .continuous)
                        ...
                        .blur(radius: 4)
                        .offset(x: -8, y: -8) // 让偏移网上 让这个外阴影成为 内阴影
            ...
            .overlay(
                HStack {
                    Image(systemName: "person.crop.circle")
                        ...
                        .clipShape(RoundedRectangle(cornerRadius: 16, style: .continuous))
                        .shadow(color: Color(#colorLiteral(red: 0.3647058904, green: 0.06666667014, blue: 0.9686274529, alpha: 1)), radius: /*@START_MENU_TOKEN@*/10/*@END_MENU_TOKEN@*/, x: 10, y: 10)
            ...
            .shadow(color: Color(press ? #colorLiteral(red: 0.7608050108, green: 0.8164883852, blue: 0.9259157777, alpha: 1) : #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)), radius: 20, x: -20, y: -20)// 压住 上面和左边面的阴影
            .scaleEffect(tap ? 1.2 : 1)
            .gesture(
                // minimumDuration 持续时间 持续距离maximumDistance
