...
struct HomeView: View {
    ...
    @Binding var showContent: Bool // 想要在 Home视图中控制
...
//                            .renderingMode(.original)
                ...
                .offset(y: -30) // 无法使上一个滚动视图更改间距 只能使用偏移
...
let sectionData = [
    ...
    Section(title: "Build a SwiftUI app", text: "20 Section", logo: "Logo2", image: Image(uiImage: #imageLiteral(resourceName: "Logo1")), color: Color("card2")),
